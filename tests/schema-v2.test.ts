...
describe("ProjectV2Schema", () => {
  ...
  it.each([
    ...
    ["percent-encoded traversal in project refs", () => ({ ...validProject(), assets: { ...validProject().assets, "asset-browser": { ...validProject().assets["asset-browser"], path: "assets/%2e%2e/private.mp4" } } })],
    ["double-encoded traversal in project refs", () => ({ ...validProject(), assets: { ...validProject().assets, "asset-browser": { ...validProject().assets["asset-browser"], path: "assets/%252e%252e/private.mp4" } } })],
